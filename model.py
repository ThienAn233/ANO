...
class UTGAN(nn.Module):
    ...
    def create_default_model(self,latent=128):
        ...
        self.encoder_dict = {'dil0':Dilated(1,e,2,1,BN=False),
            ...
            'flat':nn.Flatten(),
#             'drop':nn.Dropout(0.3),
            'lin1':nn.Linear(1026,self.latent*2,bias=None),
        ...
        self.decoder_dict = {'lin1':nn.Linear(self.latent,self.latent*2),
            'act1':nn.LeakyReLU(0.2),
            'lin2':nn.Linear(self.latent*2,1026,bias=None),
            'bat1':nn.BatchNorm1d(1026,momentum=1),
            'act2':nn.LeakyReLU(0.2),
#             'drop':nn.Dropout(0.3),
            'unfl':nn.Unflatten(-1,(u,1026//u)),
        ...
        self.datadis_dict = {'dil0':Dilated(1,e,2,1,BN=False),
            ...
            'flat':nn.Flatten(),
            'lin1':nn.Linear(1030,self.latent*2),
